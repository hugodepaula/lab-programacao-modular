...
\small
%\footnotesize
\begin{calendar}{1/29/\ANO}{22} % Semestre comeca no dia 1 de agosto, e dura por 21 semanas.
...
%
%% lista de Aulas
\caltexton{1}{Apres Disciplina. Exemplo Java.}
\caltextnext{Exemplos Java}
\caltextnext{Exemplos Java}
\caltextnext{Autodiagnóstico}
\caltextnext{Desafio Java em aula}
\caltextnext{Teste unitário}
\caltextnext{Springboot}
\caltextnext{Acompanhamento}
\caltextnext{Apresentação}
\caltextnext{Herança e polimorfismo}
\caltextnext{SpringBoot}
\caltextnext{Interfaces}
\caltextnext{Apresentação}
\caltextnext{Polimorfismo paramétrico}
\caltextnext{Acompanhamento}
\caltextnext{Coleções e Streams}
\caltextnext{Apresentação}
\caltextnext{Eventos e interface gráfica}
\caltextnext{Padrões de Projeto}
%\caltextnext{Acompanhamento}
\caltextnext{Apresentação}
